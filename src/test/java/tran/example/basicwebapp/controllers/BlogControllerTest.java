...
public class BlogControllerTest {
    ...
    public void createBlogEntryExistingBlog() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/blogs/1/blog-entries")
                .content("{\"title\":\"Generic Title\"}")
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.title", is(entry.getTitle())))
                .andExpect(jsonPath("$.links[*].href", hasItem(endsWith("api/v1/blog-entries/1"))))
                .andExpect(header().string("Location", endsWith("api/v1/blog-entries/1")))
    ...
    public void listBlogEntriesForExistingBlog() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/blogs/1/blog-entries"))
                .andDo(print())
